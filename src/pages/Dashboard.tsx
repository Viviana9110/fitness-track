...
const Dashboard = () => {
  ...
  const loadUserData = () => {
    ...
    const activityData = allActivityLogs.filter((a: ActivityEntry)=> a.createdAt?.split
    ('T')[0] === today)
  ...
  const totalBurned: number = todayActivities.reduce((sum, item)=>
        ...
        {/* Calories Card */}
          <Card className="shadow-lg col-span-2">
            ...
            <div className="mt-4 flex justify-between items-center">
              <div className={`px-3 py-1.5 rounded-lg ${remainingCalories >=
                0 ? 'bg-emerald-50 dark:bg-emerald-900/10 text-emerald-700 dark:text-emerald-400' :
                'bg-red-50 dark:bg-red-900/10 text-red-700 dar:text-red-400'
              }`}>
          ...
          <div className="dashboard-card-grid">
            ...
            <Card>
              ...
              <p className="text-2xl font-boldd text-slate-800 dark:text-white">{totalActiveMinutes}</p>
            ...
            <Card>
              ...
              <p className="text-2xl font-boldd text-slate-800 dark:text-white">{todayActivities.length}</p>
