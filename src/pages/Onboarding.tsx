    ...
    <Toaster/>
      <div className="onboarding-container">
        ...
        <div className="p-6 pt-12 onboarding-wrapper">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-4">Let's personalize tour experience</p>
        </div>
        ...
        <div className="flex-1 px-6 onboarding-wrapper">
            ...
            {step === 3 && (
              <div className="space-y-6 onboarding-wrapper">
                <div className="flex items-center gap-4 mb-8">
                  <div className="size-12 rounded-xl bg-emerald-50 dark:bg-emerald-900/10 
        ...
        <div className="p-6 pb-10 onboarding-wrapper">
          <div className="flex gap-3 lg:justify-end">
            {step > 1 && (
              <Button variant="secondary" onClick={() => setStep(step > 1 ? step - 1
                : 1)}
